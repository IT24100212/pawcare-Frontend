        ...
        const fetchAll = async () => {
            try {
                if (initialPet._id) {
                    ...
                    setPet(freshPet);
                    // Fetch medical records (including vaccinations) - Student 4
    ...
    return (
        <SafeAreaView style={styles.safe} edges={['top']}>
            ...
            <ScrollView style={styles.scroll} contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
                ...
                {/* Medical History Section - STUDENT 4: Vaccination records displayed here */}
                ...
                {loading ? (
                    ...
                    <View style={styles.recordList}>
                        {/* STUDENT 4: Map through records and display vaccination details */}
                        {records.map(record => (
                            <View key={record._id} style={styles.recordCard}>
                                <View style={styles.recordHeader}>
                                    ...
                                    <View style={styles.recordTitleBox}>
                                        {/* STUDENT 4: Show vaccine name if available */}
                                ...
                                <View style={styles.recordBody}>
                                    {/* STUDENT 4: Display vaccine name */}
                                    {record.vaccineName ? (
                                    ...
                                    {/* STUDENT 4: Display next due date for vaccines */}
                                    {record.nextDueDate ? (
                                        <View style={styles.dataRow}>
                                    ...
                                    {record.illnesses ? (
                                        <View style={styles.dataRow}>
                                            <View style={[styles.iconBox, {backgroundColor: '#ffdad6'}]}><Ionicons name="bug" size={12} color="#ba1a1a" /></View>
